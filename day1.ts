...
let name1: string="Arsalan Ahmed"
console.log(`Hello ${name1} would you like to learn some TypeScript today?`)

// Question 3: Store a person`s name in a variable, and then print that persons`s name in lowercase, uppercase, and titlecase.

let name2: string="Naveed"
